...
def extract_features(video_capture):
...
def predict_one_image(video_capture, clf, labels):
    """Predict face attributes for all detected faces in one image
    """
    face_encodings, locs = extract_features(video_capture)
...
def main3():
    ...
    parser.add_argument('--img_dir',
                        default='E:/pythonProjects/face-classification-master/test', 
                        help='input image directory (default: test/)')
    parser.add_argument('--output_dir', 
                        default='E:\pythonProjects/face-classification-master/results',
                        help='output directory to save the results (default: results/')
    parser.add_argument('--model',
                        default='E:/pythonProjects/facewebcam/4/finalfacenet20186person/facialrecognitionvideofacenetmaster/src/gender/face_model.pkl',
